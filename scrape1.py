...
for i in range(1, 4): #number of pages
    ...
    for product in products:
        ...
        Location = product.find('span', class_='s-item__location s-item__itemLocation').text    # Terminale laustiniuose skliaustuose grazina location, csv exportina su spanais. Nepriima atributo .text
